...
const afterDOBBnTxtEl = document.getElementById("afterDOBBtnTxt");
...
const updateAge = () => {
  ...
  const year = Math.floor(dateDiff / (100 * 60 * 60 * 24 * 365));
...
const contentToggler = () => {
  ...
  if (dateOfBirth) {
    ...
    afterDOBBnTxtEl.classList.remove("hide");
  } else {
    afterDOBBnTxtEl.classList.add("hide");
